...
module.exports = (app, express) => {
    ...
    // Create Conversation
    router.post('/messages/conversation', 
        Middleware.isUserAuthorized,
    ...
    // Update Conversation
    router.put('/messages/conversation/:id', 
        Middleware.isUserAuthorized,
    ...
    router.post('/tracking', 
        Middleware.isUserAuthorized,
        Middleware.requireRole(['IndustryAdmin', 'IndustryMember', 'Vendor', 'SuperAdmin']),
    ...
    router.put('/tracking/:trackingId', 
        Middleware.isUserAuthorized,
